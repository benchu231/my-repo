...
public class ApplyRemote implements ApiCall
{
        ...
        throws IOException
    {
        ...
        else if (msgApplyRemote.hasObsRemote())
        {
            ObsRemotePojo obsRemotePojo = asObsRemotePojo(
                msgApplyRemote.getObsRemote(),
                msgApplyRemote.getFullSyncId(),
                msgApplyRemote.getUpdateId()
            );
            apiCallHandler.applyObsRemoteChanges(obsRemotePojo);
        }
    ...
    static ObsRemotePojo asObsRemotePojo(IntObsRemote proto, long fullSyncId, long updateId)
    {
