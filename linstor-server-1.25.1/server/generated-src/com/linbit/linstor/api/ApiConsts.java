...
public class ApiConsts
{
    ...
    public static final long MASK_SCHEDULE = 0x0000000000540000L;
    public static final long MASK_EXT_FILES = 0x0000000000500000L;
    ...
    public static final long MASK_BACKUP = 0x0000000000080000L;
    public static final long MASK_REMOTE = 0x0000000000040000L;
    ...
    public static final long FAIL_NODE_HAS_USED_RSC = 233 | MASK_ERROR;
    public static final long FAIL_INVLD_REQUEST = 234 | MASK_ERROR;
    public static final long FAIL_INVLD_EXT_FILE_NAME = 235 | MASK_ERROR;
    public static final long FAIL_INVLD_EXT_FILE = 236 | MASK_ERROR;
    public static final long FAIL_INVLD_RSC_GRP_NAME = 237 | MASK_ERROR;
    public static final long FAIL_INVLD_BACKUP_CONFIG = 238 | MASK_ERROR;
    public static final long FAIL_INVLD_REMOTE_NAME = 239 | MASK_ERROR;
    public static final long FAIL_INVLD_TIME_PARAM = 240 | MASK_ERROR;
    public static final long FAIL_INVLD_SCHEDULE_NAME = 241 | MASK_ERROR;
    public static final long FAIL_INVLD_DB_EXPORT_FILE = 242 | MASK_ERROR;
    ...
    public static final long FAIL_NOT_FOUND_EXOS_ENCLOSURE = 319 | MASK_ERROR;
    public static final long FAIL_NOT_FOUND_EXT_FILE = 320 | MASK_ERROR;
    public static final long FAIL_NOT_FOUND_REMOTE = 321 | MASK_ERROR;
    public static final long FAIL_NOT_FOUND_BACKUP = 322 | MASK_ERROR;
    public static final long FAIL_NOT_FOUND_SCHEDULE = 323 | MASK_ERROR;
    ...
    public static final long FAIL_ACC_DENIED_EXT_FILE = 422 | MASK_ERROR;
    public static final long FAIL_ACC_DENIED_REMOTE = 423 | MASK_ERROR;
    public static final long FAIL_ACC_DENIED_SCHEDULE = 424 | MASK_ERROR;
    ...
    public static final long FAIL_EXISTS_EXOS_ENCLOSURE = 526 | MASK_ERROR;
    public static final long FAIL_EXISTS_REMOTE = 527 | MASK_ERROR;
    public static final long FAIL_EXISTS_SCHEDULE = 528 | MASK_ERROR;
    ...
    public static final long FAIL_MISSING_EBS_TARGET = 611 | MASK_ERROR;
    ...
    public static final long FAIL_POOL_EXHAUSTED_SPECIAL_SATELLTE_TCP_PORT = 805 | MASK_ERROR;
    public static final long FAIL_POOL_EXHAUSTED_SNAPSHOT_SHIPPING_TCP_PORT = 806 | MASK_ERROR;
    public static final long FAIL_POOL_EXHAUSTED_BACKUP_SHIPPING_TCP_PORT = 807 | MASK_ERROR;

    /*
     * Other failures
     */
    public static final long FAIL_EBS_COOLDOWN = 973 | MASK_ERROR;
    public static final long FAIL_NOT_ALL_UPTODATE = 974 | MASK_ERROR;
    public static final long FAIL_EVACUATING = 975 | MASK_ERROR;
    public static final long FAIL_BACKUP_UNKNOWN_CLUSTER = 976 | MASK_ERROR;
    public static final long FAIL_DEPENDEND_BACKUP = 977 | MASK_ERROR;
    public static final long FAIL_BACKUP_INCOMPATIBLE_VERSION = 978 | MASK_ERROR;
    public static final long FAIL_SNAPSHOT_NOT_UPTODATE = 979 | MASK_ERROR;
    public static final long FAIL_NOT_ENOUGH_FREE_SPACE = 980 | MASK_ERROR;
    ...
    public static final long WARN_NODE_EVICTED = 1017 | MASK_WARN;
    public static final long WARN_RSC_DEACTIVATED = 1018 | MASK_WARN;
    public static final long WARN_BACKUP_DL_ONLY = 1019 | MASK_WARN;
    public static final long WARN_NOT_EVACUATING = 1020 | MASK_WARN;
    public static final long WARN_INVLD_CONF = 1021 | MASK_WARN;
    ...
    public static final long INFO_RSC_ALREADY_EXISTS = 10008 | MASK_INFO;
    ...
    public static final String API_CRT_SNAPSHOT_MULTI = "CrtSnapshotMulti";
    public static final String API_CRT_BACKUP = "CrtBackup";
    ...
    public static final String API_CLONE_RSCDFN = "CloneRscDfn";
    public static final String API_CLONE_RSCDFN_STATUS = "CloneRscDfnStatus";
    ...
    public static final String API_ADJUST_RSC_GRP = "AdjustRscGrp";
    public static final String API_CREATE_DEVICE_POOL = "CreateDevicePool";
    public static final String API_MAKE_RSC_AVAIL = "MakeRscAvail";
    public static final String API_CRT_EXOS_ENCLOSURE = "CrtExosEnclosure";
    public static final String API_SET_REMOTE = "SetRemote";
    public static final String API_RESTORE_BACKUP = "RstBackup";
    public static final String API_ABORT_BACKUP = "AbortBackup";
    public static final String API_SHIP_BACKUP = "ShipBackup";
    public static final String API_CRT_SCHEDULE = "CrtSchedule";
    ...
    public static final String API_MOD_EXOS_DFLTS = "ModifyExosDefaults";
    public static final String API_MOD_EXOS_ENCLOSURE = "ModExosEnclosure";
    public static final String API_MOD_SCHEDULE = "ModSchedule";
    ...
    public static final String API_DEL_BACKUP = "DelBackup";
    public static final String API_LOST_NODE = "LostNode";
    public static final String API_LOST_STOR_POOL = "LostStorPool";
    public static final String API_DEL_EXOS_ENCLOSURE = "DelExosEnclosure";
    public static final String API_DEL_SCHEDULE = "DelSchedule";
    ...
    public static final String API_NODE_EVICT = "NodeEvict";
    public static final String API_NODE_EVACUATE = "NodeEvacuate";

    /*
     * List object APIs
     */
    public static final String API_LST_NODE = "LstNode";
    public static final String API_LST_NODE_CONN = "LstNodeConn";
    ...
    public static final String API_LST_BACKUPS = "LstBackups";
    public static final String API_BACKUP_INFO = "BackupInfo";
    public static final String API_LST_PROPS_INFO = "LstPropsInfo";
    public static final String API_LST_REMOTE = "LstRemote";
    public static final String API_LST_EXOS_DFLTS = "LstExosDefaults";
    public static final String API_LST_EXOS_ENCLOSURES = "LstExosEnclosures";
    public static final String API_EXOS_ENCLOSURE_EVENTS = "ExosEvents";
    public static final String API_EXOS_EXEC = "ExosExec";
    public static final String API_EXOS_MAP = "ExosMap";
    public static final String API_LST_EXT_FILES = "LstExtFiles";
    public static final String API_NODE_STATS = "NodeStats";
    public static final String API_RSC_GRP_STATS = "RscGrpStats";
    public static final String API_RSC_DFN_STATS = "RscDfnStats";
    public static final String API_RSC_STATS = "RscStats";
    public static final String API_STOR_POOL_STATS = "StorPoolStats";
    public static final String API_ERR_REPORT_STATS = "ErrReportStats";
    public static final String API_LST_SCHEDULE = "LstSchedule";
    public static final String API_LST_QUEUE = "LstQueue";
    ...
    public static final String API_QRY_SIZE_INFO = "QrySizeInfo";
    public static final String API_QRY_ALL_SIZE_INFO = "QryAllSizeInfo";
    public static final String API_RSCDFN_SYNC_STATUS = "RscDfnSyncStatus";
     ...
     * External files APIs
     */
    public static final String API_SET_EXT_FILE = "SetExtFile";
    public static final String API_DEL_EXT_FILE = "DeleteExtFile";
    public static final String API_DEPLOY_EXT_FILE = "DeployExtFile";
    public static final String API_UNDEPLOY_EXT_FILE = "UndeployExtFile";

    /*
     * Database APIs
     */
    public static final String API_DB_EXPORT = "DbExport";
    ...
    public static final String KEY_DRBD_DISABLE_AUTO_RESYNC_AFTER = "auto-resync-after-disable";
    public static final String KEY_DRBD_DISABLE_AUTO_VERIFY_ALGO = "auto-verify-algo-disable";
    public static final String KEY_DRBD_AUTO_VERIFY_ALGO_ALLOWED_USER = "auto-verify-algo-allowed-user-list";
    public static final String KEY_DRBD_AUTO_RS_DISCARD_GRANULARITY = "auto-rs-discard-granularity";
    public static final String KEY_FORCE_INITIAL_SYNC = "ForceInitialSync";
    public static final String KEY_DRBD_SKIP_DISK = "SkipDisk";
    ...
    public static final String KEY_RSC_ALLOW_MIXING_DEVICE_KIND = "AllowMixingStoragePoolDriver";
    public static final String KEY_RSC_DISKFUL_BY = "DiskfulBy";
     ...
     */
    public static final String KEY_BCACHE_POOL_NAME = "PoolName";
    public static final String KEY_BCACHE_SIZE = "Size";
    public static final String KEY_BCACHE_BLOCKSIZE = "Blocksize";
    public static final String KEY_BCACHE_BUCKETSIZE = "Bucketsize";
    public static final String KEY_BCACHE_DATA_OFFSET = "DataOffset";
    public static final String KEY_BCACHE_WRITEBACK = "Writeback";
    public static final String KEY_BCACHE_DISCARD = "Discard";
    public static final String KEY_BCACHE_CACHE_REPLACEMENT_POLICY = "CacheReplacementPolicy";
    ...
    public static final String KEY_AUTOPLACE_ALLOW_TARGET = "AutoplaceTarget";
    ...
    public static final String KEY_AUTO_EVICT_ALLOW_EVICTION = "AutoEvictAllowEviction";
     ...
     */
    public static final String KEY_BACKUP_TIMEOUT = "BackupTimeout";
    public static final String KEY_BACKUP_S3_SUFFIX = "S3KeySuffix";
    public static final String KEY_BACKUP_OBS_SUFFIX = "ObsKeySuffix";
    public static final String KEY_REMOTE = "Remote";
    public static final String KEY_MAX_CONCURRENT_BACKUPS_PER_NODE = "MaxConcurrentBackupsPerNode";
    public static final String VAL_NODE_UNDECIDED = "<undecided>";

    /*
     * Clone property keys
     */
    public static final String KEY_USE_ZFS_CLONE = "UseZFSClone";

    /*
     * NetCom namespaces
     */
    public static final String KEY_NETCOM_ENABLED = "Enabled";
    public static final String KEY_NETCOM_BIND_ADDRESS = "BindAddress";
    public static final String KEY_NETCOM_KEY_PASSWD = "KeyPasswd";
    public static final String KEY_NETCOM_KEY_STORE = "KeyStore";
    public static final String KEY_NETCOM_KEY_STORE_PASSWD = "KeyStorePasswd";
    public static final String KEY_NETCOM_PORT = "Port";
    public static final String KEY_NETCOM_SSL_PROTOCOL = "SslProtocol";
    public static final String KEY_NETCOM_TRUST_STORE = "TrustStore";
    public static final String KEY_NETCOM_TRUST_STORE_PASSWD = "TrustStorePasswd";
    public static final String KEY_NETCOM_TYPE = "Type";
    ...
    public static final String NAMESPC_BCACHE = "BCache";
    ...
    public static final String NAMESPC_STLT_DEV_SYMLINKS = "Satellite/Device/Symlinks";
    public static final String NAMESPC_EXOS = "StorDriver/Exos";
    public static final String NAMESPC_BACKUP_SHIPPING = "BackupShipping";
    public static final String NAMESPC_CLUSTER = "Cluster";
    public static final String NAMESPC_CLUSTER_REMOTE = "Cluster/Remote";
    public static final String NAMESPC_SED = "SED";
    public static final String NAMESPC_EBS = "EBS";
    public static final String NAMESPC_TAGS = "Tags";
    ...
    public static final String KEY_STOR_POOL_LVCREATE_SNAPSHOT_OPTIONS = "LvcreateSnapshotOptions";
    ...
    public static final String KEY_STOR_POOL_ZFS_SNAPSHOT_OPTIONS = "ZfsSnapshotOptions";
    ...
    public static final String KEY_STOR_POOL_EXOS_API_IP = "IP";
    public static final String KEY_STOR_POOL_EXOS_API_IP_ENV = "IPEnv";
    public static final String KEY_STOR_POOL_EXOS_API_PORT = "Port";
    public static final String KEY_STOR_POOL_EXOS_API_USER = "Username";
    public static final String KEY_STOR_POOL_EXOS_API_USER_ENV = "UsernameEnv";
    public static final String KEY_STOR_POOL_EXOS_API_PASSWORD = "Password";
    public static final String KEY_STOR_POOL_EXOS_API_PASSWORD_ENV = "PasswordEnv";
    public static final String KEY_STOR_POOL_EXOS_VLM_TYPE = "VolumeType";
    public static final String KEY_STOR_POOL_EXOS_CREATE_VOLUME_OPTIONS = "CreateVolumeOptions";
    public static final String KEY_STOR_POOL_EXOS_ENCLOSURE = "Enclosure";
    public static final String KEY_STOR_POOL_EXOS_POOL_SN = "PoolSN";
    public static final String KEY_STOR_POOL_REMOTE_SPDK_API_HOST = "RemoteSpdk/ApiHost";
    public static final String KEY_STOR_POOL_REMOTE_SPDK_API_PORT = "RemoteSpdk/ApiPort";
    public static final String KEY_STOR_POOL_REMOTE_SPDK_API_USER_NAME = "RemoteSpdk/UserName";
    public static final String KEY_STOR_POOL_REMOTE_SPDK_API_USER_PW = "RemoteSpdk/UserPassword";
    public static final String KEY_STOR_POOL_REMOTE_SPDK_API_USER_NAME_ENV = "RemoteSpdk/UserNameEnv";
    public static final String KEY_STOR_POOL_REMOTE_SPDK_API_USER_PW_ENV = "RemoteSpdk/UserPasswordEnv";
    public static final String KEY_EBS_VOLUME_TYPE = "EBS/VolumeType";
    ...
    public static final long VAL_STOR_POOL_SPACE_NOT_FOUND = -1;
    public static final long VAL_STOR_POOL_SPACE_ENOUGH = 9223372036854775807L;
    ...
    public static final String KEY_FS_USER = "User";
    public static final String KEY_FS_GROUP = "Group";
    ...
    public static final String VAL_NODE_TYPE_REMOTE_SPDK = "Remote_Spdk";
    public static final String VAL_NODE_TYPE_EXOS_TARGET = "Exos_Target";
     ...
     * External files keys
     */
    public static final String KEY_EXT_FILE = "ExtFile";

    /*
     * Default ports
     */
    public static final int DFLT_CTRL_PORT_SSL = 3371;
    public static final int DFLT_CTRL_PORT_PLAIN = 3370;
    ...
    public enum SnapshotShipStatus
    {
        ...
        SnapshotShipStatus(final String val)
        {
            enumValue = val;
        }
    ...
    public static final String FLAG_EVACUATE = "EVACUATE";
    public static final String FLAG_DELETE = "DELETE";
    public static final String FLAG_DRBD_DELETE = "DRBD_DELETE";
    ...
    public static final String FLAG_SHIPPING = "SHIPPING";
    public static final String FLAG_SHIPPING_CLEANUP = "SHIPPING_CLEANUP";
    public static final String FLAG_SHIPPING_ABORT = "SHIPPING_ABORT";
    public static final String FLAG_SHIPPED = "SHIPPED";
    public static final String FLAG_AUTO_SNAPSHOT = "AUTO_SNAPSHOT";
    public static final String FLAG_BACKUP = "BACKUP";
    public static final String FLAG_RESTORE_BACKUP_ON_SUCCESS = "RESTORE_BACKUP_ON_SUCCESS";
    public static final String FLAG_BACKUP_TARGET = "BACKUP_TARGET";
    public static final String FLAG_BACKUP_SOURCE = "BACKUP_SOURCE";
    ...
    public static final String FLAG_EBS_INITIATOR = "EBS_INITIATOR";
    ...
    public enum DeviceLayerKind
    {
        ...
        DeviceLayerKind(final String val)
        {
            enumValue = val;
        }
    ...
    public enum ConnectionStatus
    {
        ...
        ConnectionStatus(final int val)
        {
            enumValue = val;
        }
