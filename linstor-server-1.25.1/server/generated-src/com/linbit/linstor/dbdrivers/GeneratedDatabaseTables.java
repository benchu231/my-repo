...
public class GeneratedDatabaseTables
{
    ...
    public static class ObsRemotes implements DatabaseTable
    {
        private ObsRemotes()
        {
        }
    ...
    public static final ObsRemotes OBS_REMOTES = new ObsRemotes();
    ...
    static
    {
        ...
        ObsRemotes.UUID.table = OBS_REMOTES;
        ObsRemotes.NAME.table = OBS_REMOTES;
        ObsRemotes.DSP_NAME.table = OBS_REMOTES;
        ObsRemotes.FLAGS.table = OBS_REMOTES;
        ObsRemotes.ENDPOINT.table = OBS_REMOTES;
        ObsRemotes.BUCKET.table = OBS_REMOTES;
        ObsRemotes.REGION.table = OBS_REMOTES;
        ObsRemotes.ACCESS_KEY.table = OBS_REMOTES;
        ObsRemotes.SECRET_KEY.table = OBS_REMOTES;
