...
public class Backups
{
    ...
    private static final int DEL_OPT_OBS_KEY = 1 << 3;
    ...
    private static final List<Integer> DEL_OPT_ALLOWED_COMBINATIONS = Arrays.asList(
        ...
        DEL_OPT_OBS_KEY,
        DEL_OPT_OBS_KEY | DEL_OPT_CASCADE,
    ...
    public void deleteBackups(
        ...
        @DefaultValue("") @QueryParam("obsKey") String obsKey,
    ...
    )
    {
        ...
        combination |= obsKey.isEmpty() ? 0 : DEL_OPT_OBS_KEY;
        /*
