...
public class CtrlBackupShippingSentInternalCallHandler
{
        ...
        throws IOException
    {
        ...
        if (snapDfn != null)
        {
            try
            {
                ...
                // Pair<Flux, S3Remote/ObsRemote/StltRemote>
                ...
                else
                {
                    ...
                    if (handleResult.objB instanceof S3Remote || handleResult.objB instanceof ObsRemote)
                    {
                        /*
                ...
                if (remoteForSchedule instanceof S3Remote || remoteForSchedule instanceof ObsRemote)
                {
                    // s3/obs case does not have and need a stltRemote
    ...
    /**
     * @return Pair&lt;Flux, S3Remote/ObsRemote/StltRemote&gt;
     */
    ...
    /**
     * Returns the remote (s3 or obs or stlt) and sets necessary props dependent on which kind of remote it is.
     */
