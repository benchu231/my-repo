...
import com.linbit.linstor.core.objects.remotes.ObsRemoteDbDriver;
...
public class ControllerDbModule extends AbstractModule
{
    ...
    protected void configure()
    {
        ...
        bind(ObsRemoteCtrlDatabaseDriver.class).to(ObsRemoteDbDriver.class);
        bind(ObsRemoteDatabaseDriver.class).to(ObsRemoteDbDriver.class);
