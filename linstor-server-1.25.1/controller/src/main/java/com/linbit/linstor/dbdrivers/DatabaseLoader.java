...
public class DatabaseLoader implements DatabaseDriver
{
    ...
    private final ObsRemoteCtrlDatabaseDriver obsRemoteDriver;
    ...
    public DatabaseLoader(
        ...
        ObsRemoteCtrlDatabaseDriver obsRemoteDriverRef,
    ...
    )
    {
        ...
        obsRemoteDriver = obsRemoteDriverRef;
    ...
    public void loadCoreObjects() throws DatabaseException
    {
        try
        {
            ...
            Map<ObsRemote, ObsRemote.InitMaps> loadedObsRemotesMap = Collections
                .unmodifiableMap(obsRemoteDriver.loadAll(null));
            ...
            tmpRemoteMap.putAll(mapByName(loadedObsRemotesMap, ObsRemote::getName));
